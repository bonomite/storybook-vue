...
VUE_APP_EDITOR=code
                ...
                <p class="p-mb-3">A wide range of variables are available to customize different aspects of the components such as colors, margins and paddings. Refer to the <a href="https://www.primefaces.org/designer/api/primevue/3.10.0">API documentation</a> for details on each variable.</p>
